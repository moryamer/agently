...
<head>
    <meta charset="UTF-8">
    <title>إنشاء حساب - العميل والقاتل</title>
    ...
    <div class="login-container">
        ...
        <?php if (isset($_SESSION['register_error'])): ?>
            <div class="message error">
                <?= htmlspecialchars($_SESSION['register_error'], ENT_QUOTES, 'UTF-8'); unset($_SESSION['register_error']); ?>
            </div>
        <?php endif; ?>
        ...
        <form action="php/register_user.php" method="POST" autocomplete="off" novalidate>
            ...
            <input type="password" class="pass" name="confirm_password" placeholder="تأكيد كلمة المرور" required>
